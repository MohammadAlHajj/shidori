...
public class Shidori
{
	 ...
	 * creates a Jtree "tree" takes the created show list and places it in the
	 * tree
	 * 
	 * @throws FileAlreadyExists
	 * @throws FileNotFoundException
	 */
	public Shidori() throws FileNotFoundException
	{
	...
	private void scanFiles() throws FileNotFoundException
	{
		...
		// TODO make the options menu to change the root directory
		File file = new File("E:\\Anime");
		...
		for (int i = 0; i < files.length; i++)
		{
			if (files[i].isDirectory())
			{
				...
				/*
				 * the below lines can be commented out for "just in time"
				 * refresh of the tree since it was taking 10+ seconds to load 1
				 * million files and 10 thousand directories
				 */
				s.update();
			}
		}
	...
	public void populateTreeAfterInitialisation()
	{
		...
		{
			DefaultMutableTreeNode showNode =
					(DefaultMutableTreeNode) (DefaultMutableTreeNode) (treeModel
							.getChild(rootNode, i));
	...
	public AddComponent addComponentMethod(TypeHolderEnum typeToAdd)
	{
		...
		else if (typeToAdd == TypeHolderEnum.Episode)
		{
			...
			System.out.println("Unsupported TypeHOlderEnum at "
